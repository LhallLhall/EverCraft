...
def test_roll_to_set_strength():
    travis = Character('travis', 'Good', strength=15, dexterity=1, constitution=1, wisdom=7, intelligence=2, charisma=17)
...
def test_does_hp_mess_up():
    Travis = Character('Travis', 'Neutral')
    Pete = Character('Pete', 'Neutral')
    Pete.attack(20, Travis)
    Pete.attack(20, Travis)
    assert Travis.hp == 1

def test_attack_does_dmg():
    Travis = Character('Travis', 'Good', strength=15, dexterity=1, constitution=12, wisdom=7, intelligence=2, charisma=17)
    Pete = Character('Pete', 'Neutral', strength=18, dexterity=7, constitution=9, wisdom=7, intelligence=19, charisma=15)
    Travis.attack(19, Pete)
    Travis.attack(19, Pete)
    Pete.attack(19, Travis)
    # assert Travis.hp == 
    assert Pete.is_dead == True
